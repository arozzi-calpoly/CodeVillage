...
public class UnitTesting
{
    ...
    private static class GLTestSimpleShaderEventListener implements GLEventListener
    {
        ...
        public void init(GLAutoDrawable glAutoDrawable)
        {
            ...
            InputStream vertexShaderStream = classLoader.getResourceAsStream("shaders/simple_vertex_shader.glsl");
            InputStream fragmentShaderStream = classLoader.getResourceAsStream("shaders/simple_fragment_shader.glsl");
