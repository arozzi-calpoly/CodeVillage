...
public class UnitTesting
{
    ...
    */
    ...
    {
        // We first need to estimate the size of the box we need to fit everything inside
        ...
        // We also need to make sure that the total area of the XZ face of the bounding box
        ...
        // margin of error we should give ourselves for the total area of the bounding box
        ...
        for (Vec2f position : new ArrayList<>(candidatePositions)) {
            for (Box box : new ArrayList<>(rectanglesLeft)) {
                ...
                if (rectangleCanBePlaced(box, placedRectangles, containerWidth, containerHeight)) {
                    ...
                    boolean success = packRecur(rectanglesLeft, placedRectangles, candidatePositions, containerWidth, containerHeight);
                    if (success) {
                        return true;
                    } else {
